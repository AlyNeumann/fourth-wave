    ...
    return (
        <Grid templateColumns='repeat(5, 1fr)' gap={4} pt="30px">
            <GridItem colSpan={2} h='250' bg='purple.100' w={[150, 300, 500]} >
                <LotteryBoxes title="Lottery Pot" text="Current pot total: " data={[currentLotteryPot]} />
            </GridItem>
            <GridItem colStart={4} colEnd={6} h='250' bg='purple.100' w={[150, 300, 500]}>
                <LotteryBoxes title="Treasury Pot" text="Current lottery total: " data={[currentPot]} />
            </GridItem>
            <GridItem colSpan={2} h='250' bg='purple.100' w={[150, 300, 500]}>
            ...
            <GridItem colStart={4} colEnd={6} h='250' w={[150, 300, 500]} bg='purple.100'>
                <LotteryBoxes title="Past Winners" text="List of previous lottery winners: " data={state.winners} />
            </GridItem>
        </Grid>
    )
}